  ...
  if(meteorites === undefined) {
    ...
    //no meteoriteites fell during these timeframes, so display notice to user
      ...
      <div className="App">
        ...
        <output>{centurySliderValue > 800 ? `${centurySliderValue} - ${centurySliderValue / 100}99` : 'Drag to filter by centuries'} </output> {/* should be good until the year 10000 AD :) */}
      ...
      console.log("searchInput from App.js", searchInput)
        ...
        return (
          <div className="App">
            ...
            />
            <input type="range" min="700" max="2200" step="100" className="century-slider" onChange={centurySliderHandler}/>
            <output>{centurySliderValue === 700 ? `${centurySliderValue} - ${centurySliderValue / 100}99` : 'Drag to filter by centuries'} </output> {/* should be good until the year 10000 AD :) */}
