  ...
  if(centurySliderValue !== 0) {
    centurySortedMeteors = meteors.filter(meteor => {
        ...
        setCenturySliderValue(1300)
          ...
          //min = substring(1,2) + '00'
          const max = parseInt(min) + 99
          if(subM >= min && subM <= max) {
            return;
          }
        }
      ...
      console.log("searchInput from App.js", searchInput)
        ...
        return (
          <div className="App">
            ...
            />
            <input type="range" min="1300" max="2100" step="100" className="century-slider" onChange={memoizedCenturyHandler}/>
