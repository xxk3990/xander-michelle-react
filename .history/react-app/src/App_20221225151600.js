...
export default function App() {
  ...
  const centurySortedMeteors = meteors.filter(meteor => meteor.year === centurySlider)
      ...
      console.log("searchInput from App.js", searchInput)
        ...
        return (
          <div className="App">
            ...
            />
            <input type="range" min="1300" max="2100" step="100" className="century-slider" onChange={debouncedSliderHandler}/>
            <output>{centurySlider}</output>
