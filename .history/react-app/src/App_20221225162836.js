...
export default function App() {
  ...
  const [centurySliderValue, setCenturySliderValue] = useState([800, 2100]); 
      ...
      console.log("searchInput from App.js", searchInput)
        ...
        return (
          <div className="App">
            ...
            />
            <input type="range" min="800" max="2100" step="100" className="century-slider" onMouseUp={memoizedCenturyHandler}/>
