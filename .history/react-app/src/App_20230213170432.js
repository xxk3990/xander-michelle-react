...
export default function App() {
  ...
  const centurySortedMeteors = meteors.filter(meteor => meteor.year >= centurySliderValue && meteor.year <= centurySliderValue + 99);
 ...
 // let totalCountValue = 0;
  ...
  const currentMeteorData = useMemo(() => {
    ...
    return () => {
      searchedMeteors.slice(firstPageIndex, lastPageIndex);
      centurySortedMeteors.slice(firstPageIndex, lastPageIndex)
    } 
