...
export default function App() {
  ...
  if(centurySliderValue > 800) {
    centurySortedmeteorites = meteorites.filter(meteorite => {
      if(meteorite.year === undefined) {
        ...
        0800, 0900
        */ 
        if(meteorite.year.substring(0,1) === 0) {
 ...
 // let totalCountValue = 0;
  ...
  const currentmeteoriteData = useMemo(() => {
    ...
    if(centurySliderValue > 800) {
      filterSetting = centurySortedmeteorites;
      return centurySortedmeteorites.slice(firstPageIndex, lastPageIndex)
    } else {
      filterSetting = searchedmeteorites;
      ...
      console.log("searchInput from App.js", searchInput)
        ...
        return (
          <div className="App">
              ...
              totalCount={filterSetting.length} //WON'T BE ABLE TO HAVE PAGINATION CHANGE FOR MULTIPLE FILTERS IN CURRENT SETUP
              pageSize={PageSize}
