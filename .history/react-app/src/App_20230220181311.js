      ...
      if(meteorite.year === undefined) {
        ...
        */
        ...
        if(yearFirstNumber !== 1 && yearFirstNumber !== 2) {
          ...
          const parseSlider = parseInt(centurySliderValue.toString().substring(0,2));
      ...
      console.log("searchInput from App.js", searchInput)
        ...
        return (
          <div className="App">
              ...
              totalCount={filteredMs.length} //WON'T BE ABLE TO HAVE PAGINATION CHANGE FOR MULTIPLE FILTERS IN CURRENT SETUP
              pageSize={PageSize}
            ...
            <section className = "data-grid">
              {currentmeteoriteData.map(m => {
                ...
                if(parseSlider >= 1000 && parseSlider < 1400) {
                  return(
                    <h4>No meteorites fell during the selected 100 year span.</h4>
                  )
                } else {
