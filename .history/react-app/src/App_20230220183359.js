          ...
          <div className="App">
            ...
            <section className = "data-grid">
              {currentmeteoriteData.map(m => {
                if(centurySliderValue === 1000 || centurySliderValue === 1100 || 
                  centurySliderValue === 1200 || centurySliderValue === 1300) {
                  return <h4>No meteorites fell during the selected 100 year span.</h4>
                } else {
