  ...
  if(meteorites === undefined) {
    return (
      ...
      <div className="App">
        ...
        <output>{centurySliderValue} – {centurySliderValue + 99}</output>
      ...
      console.log("searchInput from App.js", searchInput)
        ...
        return (
          <div className="App">
            ...
            />
            <input type="range" min="7" max="22" step="100" className="century-slider" onChange={centurySliderHandler}/>
            <output>{centurySliderValue} – {parseInt(centurySliderValue.toString().substring(1,2)) + 99}</output>
