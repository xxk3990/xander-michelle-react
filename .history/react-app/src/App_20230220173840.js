  ...
  if(centurySliderValue > 800) {
    centurySortedmeteorites = meteorites.filter(meteorite => {
      if(meteorite.year === undefined) {
        ...
        0800, 0900
        */
        let firstYearNumber = [...meteorite.year].slice(0);
        console.log('yearArray', firstYearNumber);
        if(firstYearNumber[0] === '0') {
          console.log('first', firstYearNumber);
         // console.log(meteorite.year.substring(0,1));
