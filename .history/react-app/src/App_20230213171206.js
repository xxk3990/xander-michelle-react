...
export default function App() {
  ...
  if(centurySliderValue > 800) {
    if(meteors.year === undefined) {
      return;
    }
    centurySortedMeteors = meteors.filter(meteor => meteor.year.substring(0,4) >= centurySliderValue && meteor.year.substring(0,4) <= centurySliderValue + 99)
